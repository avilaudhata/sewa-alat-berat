...
<head>
    ...
    <title>Sign in to Gerigi Hijau Perkasa</title>
</head>
<body class="h-100 d-flex align-items-center py-2">
    <div class="form-sign w-100 m-auto p-4 text-center">
        <form action="" method="post" autocomplete="off">
            <a href="home">
                <img src="assets/img/logofinal.png" alt="Icon Gerigi HIjau Perkasa">
            </a>
            <h1 class="my-3 fs-3">Sign in to <span>Gerigi Hijau Perkasa</span></h1>
            <?php if (isset($error)): ?>
            ...
            <div class="mt-5 text-muted">
                &copy; <?= date("Y") ?>
                <a href="https://github.com/avilaudhata" target="_blank" rel="noopener noreferrer" class="link-warning text-decoration-none fw-bold">
                     Avila Udhata
                </a>
            </div>
        </form>
